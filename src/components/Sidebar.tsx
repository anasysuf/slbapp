      ...
      <div className="p-4 border-t border-slate-800 bg-slate-950/60 shrink-0 mt-auto">
        ...
        <div className="pt-2 border-t border-slate-800/80 space-y-1.5">
          <a
            ...
            className="w-full flex items-center justify-center gap-1.5 py-1.5 px-3 bg-emerald-500/15 hover:bg-emerald-500/25 text-emerald-300 border border-emerald-500/30 rounded-lg text-[11px] font-bold transition-all hover:scale-[1.02]"
          >
